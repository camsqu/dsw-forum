...
github = oauth.remote_app(
    ...
    consumer_secret=os.environ['GITHUB_CLIENT_SECRET'], #web apps password for github oauth
...
#context processors run before templates are rendered and add variable(s)
